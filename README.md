...
在 [GitHub Releases](https://github.com/patrickzw1/TodoList/releases/latest) 下载 `TodoList_0.2.8_x64-setup.exe`。当前版本面向 Windows x64 日常试用，macOS 尚未提供安装包。
...
更新包使用 Tauri 签名校验；本阶段没有 Windows Authenticode 发布者签名，系统可能显示未知发布者提示。已知范围与验证记录见 [v0.2.8 发布说明](docs/RELEASE_NOTES_v0.2.8.md)。
